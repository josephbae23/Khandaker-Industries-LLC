          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 sm:gap-12">
            ...
            <div className="lg:col-span-2">
              <div className={`bg-navy-800 p-5 sm:p-6 ${isRtl ? "text-right" : "text-left"}`} dir={isRtl ? "rtl" : "ltr"}>
                <h4 className={`text-gold-400 font-semibold text-xs sm:text-sm tracking-widest uppercase mb-3 sm:mb-4 ${isRtl ? "font-arabic" : "font-montserrat"}`}>
                ...
                <div className={`space-y-2 sm:space-y-3 ${isRtl ? "text-right" : ""}`}>
                  <a
                    ...
                    className={`flex items-center gap-2 sm:gap-3 text-white/70 hover:text-gold-400 transition-colors text-xs sm:text-sm font-montserrat ${isRtl ? "flex-row-reverse justify-end" : ""}`}
                  >
                  ...
                  <a href={`mailto:${f.email}`} className={`flex items-center gap-2 sm:gap-3 text-white/70 hover:text-gold-400 transition-colors text-xs sm:text-sm font-montserrat ${isRtl ? "flex-row-reverse justify-end" : ""}`}>
